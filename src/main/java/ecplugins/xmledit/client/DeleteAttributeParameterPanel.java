...
// DeleteAttributeParameterPanel.java --
//
// DeleteAttributeParameterPanel.java is part of ElectricCommander.
//
...
public class DeleteAttributeParameterPanel
        ...
        ParameterPanelProvider
{
    ...
    // ~ Static fields/initializers----------------------------
    private static UiBinder<Widget, DeleteAttributeParameterPanel> s_binder =
    ...
    // ~ Instance fields
    // --------------------------------------------------------
    @UiField FormBuilder deleteAttributeParameterForm;
    ...
    @Override public Widget doInit()
    {
        ...
        deleteAttributeParameterForm.addRow(false, "Source:",
            "Select the source for the xml to parse.", SOURCE, FILEPATH,
            source);
        deleteAttributeParameterForm.addRow(false, "Filepath:",
            "Path to the XML file to parse. ", FILEPATH, "", new TextBox());
        deleteAttributeParameterForm.addRow(false, "Property path:",
            "Path to the property where the xml is located. ", PROPERTY, "",
            new TextBox());
        deleteAttributeParameterForm.addRow(false, "Code:",
            "XML code to parse.", XML_CODE, "", new TextArea());
        deleteAttributeParameterForm.addRow(true, "Xpath Query:",
            "XPath query to get the parent element.", QUERY, "",
            new TextArea());
        deleteAttributeParameterForm.addRow(true, "Attribute Name:",
            "Name of the attribute to delete.", ATTRIBUTE_NAME, "",
            new TextBox());
        deleteAttributeParameterForm.addRow(false, "Delete from:",
            "Select the action to do if the query returns several elements.",
            SELECTION, "first", selection);
        deleteAttributeParameterForm.addRow(false,
    ...
    {
        boolean validationStatus = deleteAttributeParameterForm.validate();
        String  source           = deleteAttributeParameterForm.getValue(
                SOURCE);

        // QUERY is required.
        if (StringUtil.isEmpty(
                    deleteAttributeParameterForm.getValue(QUERY)
                                            .trim())) {
            deleteAttributeParameterForm.setErrorMessage(QUERY,
        ...
        if (StringUtil.isEmpty(
                    deleteAttributeParameterForm.getValue(ATTRIBUTE_NAME)
                                            .trim())) {
            deleteAttributeParameterForm.setErrorMessage(ATTRIBUTE_NAME,
                "This Field is required.");
            validationStatus = false;
        }
        ...
        if (FILEPATH.equals(source)) {
            ...
            if (StringUtil.isEmpty(
                        deleteAttributeParameterForm.getValue(FILEPATH)
                                                .trim())) {
                deleteAttributeParameterForm.setErrorMessage(FILEPATH,
                    "This Field is required.");
                validationStatus = false;
            }
        }
            ...
            if (StringUtil.isEmpty(
                        deleteAttributeParameterForm.getValue(PROPERTY)
                                                .trim())) {
                deleteAttributeParameterForm.setErrorMessage(PROPERTY,
                    "This Field is required.");
                validationStatus = false;
            }
        }
            ...
            if (StringUtil.isEmpty(
                        deleteAttributeParameterForm.getValue(XML_CODE)
                                                .trim())) {
                deleteAttributeParameterForm.setErrorMessage(XML_CODE,
                    "This Field is required.");
                validationStatus = false;
            }
        }
    ...
    {
        String source = deleteAttributeParameterForm.getValue(SOURCE);

        deleteAttributeParameterForm.setRowVisible(FILEPATH,
            FILEPATH.equals(source));
        deleteAttributeParameterForm.setRowVisible(PROPERTY,
            PROPERTY.equals(source));
        deleteAttributeParameterForm.setRowVisible(XML_CODE,
            XML_CODE.equals(source));
        deleteAttributeParameterForm.setRowVisible(XML_OUTPP,
            XML_CODE.equals(source));
    }
    ...
    @Override public Map<String, String> getValues()
    {
        ...
        Map<String, String> deleteFormValues =
            deleteAttributeParameterForm.getValues();
        ...
        actualParams.put(ATTRIBUTE_NAME, deleteFormValues.get(ATTRIBUTE_NAME));
            ...
            Collection<ActualParameter> actualParameters)
    {
        ...
        for (String key : new String[] {
            ...
            deleteAttributeParameterForm.setValue(key,
    ...
    // -------------------------------------------------------
    interface Binder
        extends UiBinder<Widget, DeleteAttributeParameterPanel> { }
}
