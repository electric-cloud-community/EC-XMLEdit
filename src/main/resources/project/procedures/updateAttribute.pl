...
$opts->{attribute_name}  = ($ec->getProperty("attribute_name"))->findvalue('//value')->string_value;
$opts->{attribute_value} = ($ec->getProperty("attribute_value"))->findvalue('//value')->string_value;
