// XPathQueryParameterPanelFactory.java --
//
// XPathQueryParameterPanelFactory.java is part of ElectricCommander.
//
...
public class XPathQueryParameterPanelFactory extends ComponentBaseFactory {

    @NotNull
    @Override
    public Component createComponent(ComponentContext jso) {
        return new XPathQueryParameterPanel();
    }
}
