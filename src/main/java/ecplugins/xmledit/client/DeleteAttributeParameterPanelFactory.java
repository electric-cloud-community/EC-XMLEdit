...
// DeleteAttributeParameterPanelFactory.java --
//
// DeleteAttributeParameterPanelFactory.java is part of ElectricCommander.
//
...
public class DeleteAttributeParameterPanelFactory
    extends ComponentBaseFactory
{
    ...
    {
            return new DeleteAttributeParameterPanel();
    }
}
